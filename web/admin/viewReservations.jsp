...
<%
    ...
    String backUrl = request.getContextPath() + "/admin/admindashboard.jsp";  // ✅ your file name
%>
...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="text-primary m-0">All Reservations (Admin)</h3>
    ...
    <div class="card p-3 shadow-sm">
        <div class="table-responsive">
            <table class="table table-striped table-bordered align-middle">
                ...
                %>
                    <tr>
                        <td colspan="14" class="text-center text-muted">No reservations found.</td>
                    </tr>
                <%
                    } else {
                        int i = 1;
                ...
                %>
                    <tr>
                        ...
                        <td style="max-width:220px; white-space:normal;"><%= r.getAddress() %></td>
                        <td><%= r.getCheckIn() %></td>
                        <td><%= r.getCheckOut() %></td>
